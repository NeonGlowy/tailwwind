  ...
  return (
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="mt-6">
            ...
            <p class="text-blue-500 text-xs italic">enter ur lock key.</p>
        </div>
        <div class="flex items-left justify-between">
            <button class="bg-blue-500 hover:bg-cyan-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">Sign In</button>
